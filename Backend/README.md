...
Backend is a dependency-free JSON API. It calls the recommendation function in
`ai/` directly and stores completed activities in a local SQLite database.
...
The default dataset is `case_1/career_quest_dataset/`. Set
